    ...
    return (
        <div className="flex justify-between p-16 ">
            ...
            <div className="flex gap-4">
                <p className="my-6"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                ...
                <button className="btn bg-white my-3 border-[#FF3811] text-[#FF3811]">Appointment</button>
            </div>
        </div>
    );
};
